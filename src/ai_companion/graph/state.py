...
## It manages conversation history and stores the last message received.


## this class organizes and stores various pieces of information 
# (like messages, audio, images, and activity details) to help the AI companion interact in a flexible and context-aware way.